...
Route::get('/',  [SipenmaruController::class, 'login'])->name('login')->middleware('guest');
...
Route::get('/data-pasien', [SipenmaruController::class, 'datapasien']);
Route::get('/riwayat-pemeriksaan/{id}', [SipenmaruController::class, 'riwayatpasien']);
Route::post('/save-pasien', [SipenmaruController::class, 'simpanpasien']);
...
Route::get('/pemeriksaan', [SipenmaruController::class, 'riwayatpemeriksaan']);
Route::post('/save-pemeriksaan', [SipenmaruController::class, 'simpanpemeriksaan']);
Route::get('/pemeriksaan/print', [SipenmaruController::class, 'printpemeriksaan']);
Route::get('/detail-pemeriksaan/{id}', [SipenmaruController::class, 'detailpemeriksaan']);
