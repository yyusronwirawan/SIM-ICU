...
<head>
    ...
    <style>
        ...
        /* @media only screen and (max-width: 87.5rem) .side-bar-profile {
            display: none;
        } */
    </style>
        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                <div class="side-bar-profile">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div class="side-bar-profile-img">
                            ...
                            <img class="avatar-lg rounded-circle img-thumbnail" src="{{ asset('image/'.auth()->user()->image ) }}" alt="" />
                            @else
                        ...
                        <div class="profile-info1">
                            <h4 class="fs-18 font-w600">{{ auth()->user()->name }}</h4>
                            <span>{{ auth()->user()->email }}</span>
                        </div>
                        <div class="profile-button">
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                <i class="fas fa-caret-down scale5 text-light"></i>
                                <div class="dropdown-menu dropdown-menu-end" style="inset: 0px auto auto 30px!important;">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/data-pasien">Pasien</a></li>
                ...
                <div class="copyright">
                    <p><strong>SIM ICU</strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved
                    </p>
                    <p class="fs-12">Made with<span class="heart"></span> by SIM ICU</p>
                </div>
            </div>
        </div>
        <!--**********************************
