                                                ...
                                                <div class="card-body px-4 pb-0">
                                                    ...
                                                    @foreach ($viewTotal as $x)
                                                        <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                                                            <span>{{ $hasil }} yang telah diberi <br> pengumuman,
                                                                dari</span>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="form-registration"><button type="button" class="btn btn-primary mb-4"
                                        style="margin-bottom: 1rem;"><i class="mdi mdi-plus me-1"></i>Add
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-sm-8">
                                    <div style="text-align: center;">
                                        <img src="{{ asset('sipenmaru/images/banner1.png') }}" alt=""
                                             height="250px">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion accordion-header-shadow accordion-rounded" id="accordion-ten">
                            <div class="accordion-item">
                                <div class="accordion-header  rounded-lg" id="accord-10One" data-bs-toggle="collapse"
                                    ...
                                    <span class="accordion-header-text">Sudah kenal dengan Politeknik Enjinering
                                        Indorama?</span>
                                ...
                                <div id="collapse10One" class="collapse accordion__body show" aria-labelledby="accord-10One"
                                    ...
                                    <div class="accordion-body-text">
                                        <span class="fs-16 font-w400">
                                            <h5 style="text-indent: 0.5in;text-align: justify;">PEI adalah kampus luas yang
                                                dirancang dengan fasilitas yang menyeluruh untuk pendidikan teknik yang
                                                berkualitas. PEI menghasilkan sumber daya manusia bidang teknik berkualitas
                                                tinggi untuk industri. PEI memiliki visi untuk menjadi lembaga pendidikan vokasi
                                                kelas dunia.</h5>
                                            <h5 style="text-indent: 0.5in;text-align: justify;">PT Indo-Rama Synthetic Tbk,
                                                sebagai organisasi manufaktur, sangat merasakan perlunya turut serta dalam
                                                memajukan pendidikan vokasi di negara ini demi manfaat bersama bagi para calon
                                                mahasiswa pada khususnya dan industri pada umumnya. Untuk memenuhi tujuan ini,
                                                sebagai bagian dari program Corporate Social Responsibility, kampus hijau
                                                Politeknik Enjinering Indorama didirikan di Purwakarta pada tahun 2013 di atas
                                                tanah subur seluas 6 hektar dengan investasi sebesar 6 juta dolar. Politeknik
                                                Enjinering Indorama akan mengantarkan para mahasiswa-mahasiswinya meraih gelar
                                                Ahli Madya dan Sarjana Terapan di bidang vokasi. Politeknik Enjinering Indorama
                                                (PEI) merupakan lembaga nirlaba. Kelebihan kas dialokasikan kembali untuk
                                                pembangunan infrastruktur. PEI juga didukung oleh Pemerintah Daerah dan
                                                perusahaan melalui program beasiswa bagi siswa berprestasi untuk melanjutkan
                                                studi. PEI juga bekerja sama dengan berbagai universitas lokal dan internasional
                                                dalam menyediakan pendidikan vokasi berkualitas tinggi.</h5>
                                            <h5 style="text-indent: 0.5in;text-align: justify;">PEI berdiri dengan ditandai
                                                diterbitkannya Surat Keputusan Menteri Pendidikan dan Kebudayaan Nomor
                                                273/E/O/2013 tanggal 18 Juli 2013 yang diikuti dengan peresmian kampus PEI pada
                                                tanggal 23 September 2013 oleh Menteri Pendidikan & Kebudayaan dan Menteri
                                                Perindustrian & Perdagangan. Sejak diresmikan, beberapa pejabat senior seperti
                                                para Menteri, Duta Besar, CEO, pejabat tinggi, Ahli, dan perwakilan organisasi
                                                telah berkunjung ke PEI. Dari kunjungan-kunjungan tersebut, terciptalah
                                                upaya-upaya bersama dalam penyetaraan dengan institusi terkemuka lainnya,
                                                sehingga terwujud perkembangan yang berkelanjutan.</h5>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header collapsed rounded-lg" id="accord-10Two"
                                     data-bs-toggle="collapse" data-bs-target="#collapse10Two" aria-controls="collapse10Two"
